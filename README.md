...
## Servicios
 ...
 `sqlite.service.ts` Servicio de base de datos local SQLite utilizado para almacenar los centros médicos marcados como favoritos en el dispositivo Android, permitiendo persistencia offline y mejora de rendimiento en móvil
